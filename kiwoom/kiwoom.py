...
class Kiwoom(QAxWidget):
    ...
    def not_concluded_account(self, sPrevNext="0"):
        print("미체결 종목 요청")
        self.dynamicCall("SetInputValue(QString, QString)", "계좌번호", self.account_num)
        self.dynamicCall("SetInputValue(QString, QString)", "체결구분", "1") # 미체결에 대한
        self.dynamicCall("SetInputValue(QString, QString)", "매매구분", "0") # 전체 다 가져오겠다
        ...
        if sRQName == "예수금상세현황요청":
            ...
            for i in range(rows):
                ...
                if order_no in self.not_account_stock_dict:
                    ...
                    not self.not_account_stock_dict[order_no] = {}
